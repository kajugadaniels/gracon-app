...
import { ProfileCard, PlatformIdCard, VerificationStatus } from '@/components/pages/dashboard';
import { EditProfileModal } from '@/components/pages/dashboard/EditProfileModal';
import { ChangePasswordModal } from '@/components/pages/dashboard/ChangePasswordModal';
