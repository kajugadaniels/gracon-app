 ...
 * Single unified loader used everywhere: buttons, page transitions,
 * camera overlays, email verification screens.
 */
export function PremiumLoader({ size = 18, color = 'white' }: PremiumLoaderProps) {
